...
export function NavMenu() {
    ...
    const handleCheckout = () => {
        if (!user) {
            ...
            // Använd en liten fördröjning för att säkerställa att modalen stängs först
            setTimeout(() => {
                navigate('/login', { state: { from: '/BuyGiftCard' } });  // Omdirigera till inloggningssidan
            }, 300);  // Fördröjningen kan justeras beroende på vad som fungerar bäst
        } else {
