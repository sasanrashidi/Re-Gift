...
function masterSeeds() {
    return {
        ...
        "_music": {
            "jsonGroupNames": "Led, Zeppelin, Queen, Pink, Floyd, Creedence, Clearwater, Revival, Arosmith, Who, AC/DC, Rolling, Stones, Eagles, Deep, Purple, Prince, Dylan",
            "jsonAlbumNames": "Heaven, Rock, Moon, Cosmos, Walk, Hunky, Blue, Highway, Satisfaction, California, Stairway, Purple, Senor",
